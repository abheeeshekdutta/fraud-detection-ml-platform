...
6. Open MLflow at `http://localhost:5001` and show synthetic smoke runs or IEEE-CIS candidate runs.
...
- Synthetic smoke artifacts are useful for local startup; IEEE-CIS logistic regression, CatBoost, and LightGBM candidate workflows are available for real-data benchmarking.
